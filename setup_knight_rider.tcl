...
# File: setup_knight_rider.tcl
# Generated on: Mon Dec 21 00:41:09 2020
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "knight_rider"]} {
		puts "Project knight_rider is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists knight_rider]} {
		project_open -revision knight_rider knight_rider
	} else {
		project_new -revision knight_rider knight_rider
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "00:33:35  DECEMBER 21, 2020"
	...
	set_global_assignment -name VERILOG_FILE knight_rider.v
	set_global_assignment -name TCL_SCRIPT_FILE ../ReferenceDesigns/test_board_prebuild/board_files/TEI0003/TEI0003_pin_assignments.tcl
